...
export default function EditSourceInput({
    sourceEditState,
}: IEditSourceInputProps) {
    ...
    return (
        <Input
            ...
            onChange={(e) =>
                setSourceEdit({ ...sourceEdit, newTitle: e.target.value })
            }
            addonAfter={
                <>
                    {contextHolder}
                    <EditOutlined
                        onClick={() => {
                            if (sourceEdit.newTitle !== sourceEdit.title) {
                                const [title, link] =
                                    sourceEdit.newTitle.split(LINE_SPLITTER)
                                putSource(sourceEdit.id, {
                                    title,
                                    link: link || null,
                                })
                            } else {
